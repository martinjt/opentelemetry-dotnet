...
namespace OpenTelemetry.Exporter.Honeycomb
{
    public class HoneycombExporter : SpanExporter
    {
        ...
        public async override Task<ExportResult> ExportAsync(IEnumerable<Span> batch, CancellationToken cancellationToken)
        {
        ...
        private IEnumerable<HoneycombEvent> GenerateEvent(Span span)
        {
            ...
            foreach (var label in span.LibraryResource.Labels)
            {
